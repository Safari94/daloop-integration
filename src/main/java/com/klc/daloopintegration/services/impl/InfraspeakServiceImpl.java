...
public class InfraspeakServiceImpl implements InfraspeakService {
    ...
    public void postToMaintenanceService(String  stationId, Integer problemId){

        TicketBody ticketBody = new TicketBody(problemId,stationId);

        RestClient restClient = RestClient.create();
        ResponseEntity<Void> response = restClient.post()
                .uri(URI.create("http://dashboard-klc.izertislabs.pt/api/maintenance/notes"))
